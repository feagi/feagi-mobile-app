  ...
  useEffect(() => {
    ...
    const loadAPI = async () => {
      try {
        ...
        const apiValue = await AsyncStorage.getItem("userSession");
  ...
  useEffect(() => {
    const loadControls = async () => {
      ...
      if (!api) {
        ...
        var JSONStringPlaceholder = await {
          ___pwr: {
            cortical_name: "Brain_Power",
            cortical_group: "CORE",
            cortical_sub_group: "",
            visible: true,
            coordinates_2d: [null, null],
            coordinates_3d: [10, 0, -20],
            cortical_dimensions: [1, 1, 1],
          },
          _death: {
            cortical_name: "Brain_Death",
            cortical_group: "CORE",
            cortical_sub_group: "",
            visible: true,
            coordinates_2d: [null, null],
            coordinates_3d: [10, 0, -30],
            cortical_dimensions: [1, 1, 1],
          },
          i__inf: {
          ...
          o__mot: {
            ...
            coordinates_2d: [-8, -91],
            coordinates_3d: [40, 0, 0],
            cortical_dimensions: [2, 1, 10],
            dev_count: 1,
            cortical_dimensions_per_device: [2, 1, 10],
          },
          C7Vcor: {
            cortical_name: "cory",
            cortical_group: "CUSTOM",
          ...
          iv00CC: {
            ...
            cortical_sub_group: "",
            visible: true,
            coordinates_2d: [41, 157],
            coordinates_3d: [30, 100, -20],
            cortical_dimensions: [96, 32, 3],
            dev_count: 3,
            cortical_dimensions_per_device: [32, 32, 3],
          },
          iv00_C: {
            ...
            cortical_sub_group: "",
            visible: true,
            coordinates_2d: [42, 107],
            coordinates_3d: [30, 40, -20],
            cortical_dimensions: [192, 64, 1],
            dev_count: 3,
            cortical_dimensions_per_device: [64, 64, 1],
          },
          iv00TL: {
            ...
            cortical_sub_group: "",
            visible: true,
            coordinates_2d: [76, 128],
            coordinates_3d: [20, 105, -20],
            cortical_dimensions: [24, 8, 1],
            dev_count: 3,
            cortical_dimensions_per_device: [8, 8, 1],
          },
          iv00TM: {
            ...
            cortical_sub_group: "",
            visible: true,
            coordinates_2d: [91, 56],
            coordinates_3d: [55, 105, -20],
            cortical_dimensions: [24, 8, 1],
            dev_count: 3,
            cortical_dimensions_per_device: [8, 8, 1],
          },
          iv00TR: {
            ...
            cortical_sub_group: "",
            visible: true,
            coordinates_2d: [74, 127],
            coordinates_3d: [95, 105, -20],
            cortical_dimensions: [24, 8, 1],
            dev_count: 3,
            cortical_dimensions_per_device: [8, 8, 1],
          },
          iv00ML: {
            ...
            cortical_sub_group: "",
            visible: true,
            coordinates_2d: [61, 163],
            coordinates_3d: [20, 70, -20],
            cortical_dimensions: [24, 8, 1],
            dev_count: 3,
            cortical_dimensions_per_device: [8, 8, 1],
          },
          iv00MR: {
            ...
            cortical_sub_group: "",
            visible: true,
            coordinates_2d: [81, 156],
            coordinates_3d: [95, 70, -20],
            cortical_dimensions: [24, 8, 1],
            dev_count: 3,
            cortical_dimensions_per_device: [8, 8, 1],
          },
          iv00BL: {
            ...
            cortical_sub_group: "",
            visible: true,
            coordinates_2d: [99, 12],
            coordinates_3d: [20, 30, -20],
            cortical_dimensions: [24, 8, 1],
            dev_count: 3,
            cortical_dimensions_per_device: [8, 8, 1],
          },
          iv00BR: {
            ...
            cortical_sub_group: "",
            visible: true,
            coordinates_2d: [59, 144],
            coordinates_3d: [95, 30, -20],
            cortical_dimensions: [24, 8, 1],
            dev_count: 3,
            cortical_dimensions_per_device: [8, 8, 1],
          },
          iv00BM: {
            ...
            cortical_sub_group: "",
            visible: true,
            coordinates_2d: [73, 16],
            coordinates_3d: [55, 30, -20],
            cortical_dimensions: [24, 8, 1],
            dev_count: 3,
            cortical_dimensions_per_device: [8, 8, 1],
          },
          o_mctl: {
            ...
            cortical_sub_group: "",
            visible: true,
            coordinates_2d: [1019, 98],
            coordinates_3d: [20, 0, -10],
            cortical_dimensions: [8, 3, 10],
            dev_count: 2,
            cortical_dimensions_per_device: [4, 3, 10],
          },
        }.toString();
        ...
        <View style={styles.controlBox}>
          ...
          {control.type === "1D" && control.valueSlider ? (
            ...
            control.valueSwitch.map((switchState, index) => (
              ...
              >
                <Text style={styles.switchText}>{index}</Text>
